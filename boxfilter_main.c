...
int main(int argc, char** argv) {
    ...
    */
    ...
    if(min_f < 0.0f) {
        ...
        min_index = out_form.nr_sample_points/2.0;
    } else {
        min_index = (min_f/float_form.frequency_in_hz) * out_form.nr_sample_points;
    }
    if(max_f < 0.0f) {
        max_index = 0;
    } else if (max_f > float_form.frequency_in_hz/2.0) {
        max_index = out_form.nr_sample_points/2.0;
    } else {
        max_index = (max_f/float_form.frequency_in_hz) * out_form.nr_sample_points;
    }
