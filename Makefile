...
.PHONY: all
all: $(WAV-TARGET) $(FFT-TARGET) $(GRAPH-TARGET) $(PEAK-TARGET) $(MIC-SRC-TARGET) $(STRETCH-SRC-TARGET) $(IFFT-TARGET) $(PLAY-TARGET) $(REDUCE-TARGET) $(PEAK-DBG-TARGET) $(CHANGE_ROLLOFF_VELOCITY-TARGET) $(CHANGE_ROLLOFF_SLOPE-TARGET) $(NFTEST-TARGET) $(BFILTER-TARGET) $(WNDW-TARGET)
